...
(function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button0, file$1, 12, 4, 458);
    			div0.className = "fc-counter-value svelte-a5qlz5";
    			add_location(div0, file$1, 13, 4, 548);
    			button1.className = "fc-increase svelte-a5qlz5";
    			add_location(button1, file$1, 14, 4, 600);
    			div1.className = "fc-counter-wrapper svelte-a5qlz5";
    			add_location(div1, file$1, 11, 0, 420);
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$2, 31, 4, 997);
    ...
    // (28:0) {#if hasFinishedRepetitions}
    function create_if_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button0, file$2, 28, 4, 852);
    			button1.className = "svelte-rdp1p5";
    			add_location(button1, file$2, 29, 4, 906);
